...
/*   Updated: 2022/07/04 11:12:38 by iugolin          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	print_usage(void)
{
  ...
  ./philo [1] [2] [3] [4] [*5] \n\n\
   ...
   2 > time_to_die (milliseconds) (from 60 to MAX_INT)\n\
   3 > time_to_eat (milliseconds) (from 60 to MAX_INT)\n\
   4 > time_to_sleep(milliseconds) (from 60 to MAX_INT)\n\
